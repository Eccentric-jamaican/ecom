...
export function Hero() {
  return (
    <section className="mt-6 mb-10 md:mt-8 md:mb-12">
      <div className="relative overflow-hidden rounded-2xl bg-slate-900 shadow-xl min-h-[400px] md:h-[500px]">
        ...
        <div className="relative z-10 flex flex-col items-start justify-center gap-6 px-4 py-12 md:px-8 md:py-20 lg:px-16 lg:py-32 max-w-2xl h-full">
